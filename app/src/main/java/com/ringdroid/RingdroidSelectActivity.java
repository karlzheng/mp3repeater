    ...
    implements TextWatcher
{
    ...
    Cursor createCursor(String filter) {
         ...
         */
        //Cursor c = new MergeCursor(new Cursor[] {getInternalAudioCursor(selection, argsArray)});
        //Cursor c = new MergeCursor(new Cursor[] {getExternalAudioCursor(selection, argsArray)});
        
		Cursor c = searchMySDCardMusic();
    ...
    private void refreshListView() {
        ...
        Cursor c = createCursor(filterStr);
